...
test("var in𝐬𝐭𝐚𝐧𝐜𝐞𝐨𝐟;", {}, {ecmaVersion: 6})
...
testFail("await a", "Expected a semicolon (1:6)", {ecmaVersion: 8})
...
//testFail("abc: async function a() {}", "Unexpected token (1:4)", {ecmaVersion: 8})

testFail("async function𝐬 f() {}", "Expected a semicolon (1:6)", {ecmaVersion: 8})
